    ...
    <div style={{ padding: '32px', maxWidth: '1120px', margin: '0 auto', fontFamily: F, display: 'flex', flexDirection: 'column', gap: '26px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.6fr) 1fr', gap: '20px' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', top: '-30px', right: '-30px', width: '90px', height: '90px', borderRadius: '50%', background: purpleAlpha(0.06) }} />
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                boxShadow: copied ? 'none' : `0 3px 10px ${purpleAlpha(0.3)}`,
              }}
          ...
          {canConvert ? (
                  ...
                  {[...CONVERT_PRESETS, data.creditsBalance].map((amt, i) => {
                    ...
                    return (
                      <button key={i} onClick={() => setConvertAmount(String(amt))} style={{
                        ...
                        cursor: 'pointer',
                        boxShadow: selected ? `0 3px 10px ${purpleAlpha(0.3)}` : 'none',
                        transition: 'all .15s',
                      }}>
                        {label}
                      </button>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '13px', color: 'var(--muted)', fontFamily: F, lineHeight: 1.5 }}>
                Gana creditos para lanzar campanas gratis. Desbloquea nivel <strong style={{ color: PURPLE }}>Power</strong> para retirar dinero.
              </div>
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          {data.referrals.length === 0 ? (
            ...
            <div>
              {/* Table header */}
              <div style={{
                display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 90px',
...
function ReferralRow({ referral, isLast }) {
  ...
  const dateStr = referral.createdAt
    ? new Date(referral.createdAt).toLocaleDateString('es', { day: '2-digit', month: 'short', year: 'numeric' })
    : referral.date || '-'
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ fontSize: '13.5px', fontWeight: 500, color: 'var(--text)', fontFamily: F }}>
