...
const HERO_PHASES = {
  ...
  purple: {
    ...
    subtitle: 'Publica en comunidades reales de WhatsApp, Telegram y Discord. Pago protegido con escrow, metricas verificadas con tracking links y engagement 15-45x superior a paid media.',
    cta: 'Reservar mi plaza',
    ctaHref: '/auth/register',
    ctaSecondary: 'Ver como funciona',
    ctaSecondaryHref: '#como-funciona',
    metrics: [
      { value: 7, suffix: '', label: 'Plataformas soportadas' },
      { value: 15, suffix: '-45%', label: 'Engagement medio' },
      { value: 0, suffix: '%', label: 'Comision para ti' },
    ],
  ...
  green: {
    ...
    subtitle: 'Registra tu canal, verifica tus credenciales y empieza a acumular creditos invitando a otros creadores. Cuando abra el marketplace, seras de los primeros.',
    ...
    metrics: [
      ...
      { value: 5, suffix: '%', label: 'Creditos por referido' },
    ],
