...
const ROUTES = [
  ...
  // /rankings and /explore are data-driven: a headless capture only grabs the
  // navbar + heading before the API rows render, so they're handled separately
  // (build-time data fetch / dedicated static list) rather than snapshotted here.
  // The 'live' source mechanism below is kept for when that list is ready.
];
