...
const CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { icon: LineChart, name: 'Realtime Monitor', desc: 'Monitoriza el rendimiento de campañas al instante', metric: 'Live data' },
      { icon: TrendingUp, name: 'Audience Insights', desc: 'Datos demográficos y de interés de cada canal', metric: '15+ métricas' },
    ],
  },
  {
    id: 'optimization',
    ...
    color: '#f59e0b',
    tools: [
      { icon: Target, name: 'ROI Forecast', desc: 'Predicción de ROAS antes de invertir un céntimo', metric: '4.2x ROAS' },
      { icon: FlaskConical, name: 'A/B Test Lab', desc: 'Testea copys, creativos y segmentos antes de escalar', metric: '3 tests activos' },
      { icon: Sparkles, name: 'Copy Analyzer', desc: 'IA que analiza y puntúa tu texto publicitario por canal', metric: 'Score 0-100' },
  ...
  },
  {
    ...
    color: '#8b5cf6',
    tools: [
      { icon: Send, name: 'Bulk Launcher', desc: 'Lanza 50+ campañas simultáneas con un solo click', metric: '50+ / día' },
      { icon: Megaphone, name: 'Campaign Builder', desc: 'Wizard guiado: canal, copy, presupuesto y pago seguro', metric: '4 pasos' },
      { icon: MousePointerClick, name: 'Auto-Buy', desc: 'Reglas automáticas para comprar en canales que cumplen criterios', metric: 'Set & forget' },
