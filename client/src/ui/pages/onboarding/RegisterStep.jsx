...
export default function RegisterStep() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = { email, password, role: 'creator' }
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '15px', color: 'var(--muted)', marginBottom: refCode ? '16px' : '32px', textAlign: 'center', lineHeight: 1.5 }}>
      ...
      {refCode && (
        <div style={{
          ...
          color: '#10b981', borderRadius: '10px', padding: '10px 14px',
          fontSize: '13px', fontWeight: 600, textAlign: 'center', marginBottom: '24px',
        }}>
          Código de referido aplicado: <span style={{ fontFamily: 'monospace' }}>{refCode}</span>
        </div>
      )}
