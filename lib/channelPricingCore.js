...
// advertiser pays this × COMMISSION_MULTIPLIER. Deliberately well under the ~12 €
// Meta/Google paid-media CPM so the "cheaper than paid media" story stays true
// even after niche premiums (cripto ×1.3, finanzas ×1.5).
//
...
// Platform CPM multiplier — demand / quality of a single impression.
const PLATFORM_CPM_MULT = { telegram: 1.0, whatsapp: 1.1, discord: 0.95, newsletter: 1.2 };

// Niche CPM multiplier — advertiser-demand premium/discount vs the marketplace mean.
